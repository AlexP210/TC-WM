...
What should a world model represent for planning and control beyond visual? The visual representation itself, bent into a compact, task-centric latent aligned with the agent's physical state.
